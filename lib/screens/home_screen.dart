...
import 'package:rick_morty_app/screens/character_favorite_list_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  int _currentIndex = 0;
  final List<Widget> _tabs = const [CharacterListScreen(), CharacterFavoriteListScreen()];
